...
namespace app_contable
{
	public partial class Balance_de_Comprobacion
	{
		...
		protected virtual void Build()
		{
			...
			// Widget app_contable.Balance_de_Comprobacion
			this.Name = "app_contable.Balance_de_Comprobacion";
			this.Title = global::Mono.Unix.Catalog.GetString("Balance de Comprobacion");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Container child app_contable.Balance_de_Comprobacion.Gtk.Container+ContainerChild
			...
			global::Gtk.Fixed.FixedChild w2 = ((global::Gtk.Fixed.FixedChild)(this.fixed1[this.calendar2]));
			w2.X = 393;
			w2.Y = 100;
			// Container child fixed1.Gtk.Fixed+FixedChild
			this.label1 = new global::Gtk.Label();
			this.label1.Name = "label1";
			this.label1.LabelProp = global::Mono.Unix.Catalog.GetString("Fecha de finalizacion");
			...
			global::Gtk.Fixed.FixedChild w4 = ((global::Gtk.Fixed.FixedChild)(this.fixed1[this.calendar1]));
			w4.X = 31;
			w4.Y = 97;
			// Container child fixed1.Gtk.Fixed+FixedChild
			...
			this.label3.LabelProp = global::Mono.Unix.Catalog.GetString("Balance de comprobacion");
			...
			this.button2.Label = global::Mono.Unix.Catalog.GetString("Volver");
